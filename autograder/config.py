...
class SegmentationPostprocessConfig(BaseModel):
    ...
    candidate_min_ink_per_row: int = Field(default=32, ge=0, le=10000)
    candidate_bridge_gap: int = Field(default=4, ge=0, le=512)
    candidate_region_merge_gap: int = Field(default=12, ge=0, le=512)
    candidate_snap_padding: int = Field(default=16, ge=0, le=512)
    candidate_vertical_margin: int = Field(default=8, ge=0, le=512)
    candidate_split_min_height: int = Field(default=320, ge=0, le=4096)
    candidate_split_min_piece_height: int = Field(default=96, ge=1, le=2048)
    candidate_rule_threshold: int = Field(default=210, ge=0, le=255)
    candidate_rule_min_width_ratio: float = Field(default=0.55, ge=0.0, le=1.0)
